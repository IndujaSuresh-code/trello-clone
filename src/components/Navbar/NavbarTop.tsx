...
function NavbarTop() {
  return (
    <nav className="navbar">
      <img src="/icons/menu1.png" alt="icon" className="navbar-icon" />
      ...
      <img src="/icons/help.png" alt="help" className="navbar-help" />
      <img src="/images/30.png" alt="profile" className="navbar-profile" />
    </nav>
  );
}
